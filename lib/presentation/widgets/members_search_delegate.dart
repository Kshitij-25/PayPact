...
class MembersSearchDelegate extends SearchDelegate<String> {
  final List<String> existingMemberIds;
  final String groupId;
  WidgetRef ref;

  MembersSearchDelegate({
    required this.groupId,
    required this.existingMemberIds,
    required this.ref,
  }) : super(
         searchFieldLabel: 'Search by email ...',
    ...
    return StreamBuilder<List<FriendModel>>(
      ...
      builder: (context, snapshot) {
        ...
        final results = snapshot.data!
            .where(
              (user) => !existingMemberIds.contains(user.userId),
            )
            .toList();
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        return GestureDetector(
          onTap: () async {
            try {
              groupRepository.addMembersToGroup(groupId, [userId]);
              if (context.mounted) {
